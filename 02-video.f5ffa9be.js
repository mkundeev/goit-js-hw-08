...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector("#vimeo-player"),o=new Vimeo.Player(r),l=function({seconds:e}){localStorage.setItem("videoplayer-current-time",e)};o.on("timeupdate",(0,e.default)(l,1e3)),o.setCurrentTime(localStorage.getItem("videoplayer-current-time"));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.f5ffa9be.js.map