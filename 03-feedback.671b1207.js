...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector(".feedback-form"),o={},a="feedback-form-state";function n(e){o[e.target.name]=e.target.value,localStorage.setItem(a,JSON.stringify(o))}function l(e){e.preventDefault(),console.log(JSON.parse(localStorage.getItem(a))),localStorage.removeItem(a),e.currentTarget.reset()}function c(){const e=JSON.parse(localStorage.getItem(a));if(e)for(let t of Object.keys(e))r[t].value=e[t]}r.addEventListener("input",(0,e.default)(n,500)),r.addEventListener("submit",l),c();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.671b1207.js.map